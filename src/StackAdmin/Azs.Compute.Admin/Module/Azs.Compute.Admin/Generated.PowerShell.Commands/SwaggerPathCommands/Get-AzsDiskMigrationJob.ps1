...
<#
.SYNOPSIS
    Get or List migration job status
...
.EXAMPLE
    ...
    PS C:\> $migration = Get-AzsDiskMigrationJob -location local -Name $migrations[0].MigrationId
#>
function Get-AzsDiskMigrationJob
{
    ...
    param(    
        ...
        [Parameter(Mandatory = $false, ParameterSetName = 'DiskMigrationJobs_Get')]
        [Parameter(Mandatory = $false, ParameterSetName = 'DiskMigrationJobs_List')]
        [System.String]
        $Location,
